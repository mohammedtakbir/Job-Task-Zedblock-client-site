        ...
        <section className='flex justify-center'>
            <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                <form class="space-y-6" action="#" onSubmit={handleSubmit}>
                    <h5 class="text-xl font-medium text-gray-900 text-center">Register</h5>
                    <div>
                    ...
                    <div class="text-sm font-medium text-gray-500">
                        Already have an account? <Link to='/login' class="text-blue-700 hover:underline">Create account</Link>
                    </div>
                </form>
            </div>
        </section>
